...
public class JwtConverter implements Converter<Jwt, AbstractAuthenticationToken>{
	...
	public AbstractAuthenticationToken convert(Jwt jwt) {
		...
		return new JwtAuthenticationToken(jwt, authorities, getPrincipalClainName(jwt));
	}
	
	private String getPrincipalClainName(Jwt jwt) {
		String clainName = JwtClaimNames.SUB;
		if (properties.getPrincipalAttribute() != null) {
			clainName = properties.getPrincipalAttribute();
		}
		LOGGER.info("Bienvenido: "+jwt.getClaim(clainName));
